...
export function NumericalColorChooser(props: NumericalColorChooserProps) {
    ...
    return (
        <>
            <div key={`numericalColorChooserRadio`} className="btn-group w-100 px-2 pt-3" role="group" aria-label="Basic outlined example">
                ...
                <label style={{zIndex: 0}} className={`btn btn-outline-primary w-100 ${props.disabled ? 'disabled' : ''}`} htmlFor={`formButton${ENumericalColorScaleType.SEQUENTIAL}`} title="Sequential Color Scale">{ENumericalColorScaleType.SEQUENTIAL}</label>
                ...
                <label style={{zIndex: 0}} className={`btn btn-outline-primary w-100 ${props.disabled ? 'disabled' : ''}`} htmlFor={`formButton${ENumericalColorScaleType.DIVERGENT}`} title="Divergent Color Scale">{ENumericalColorScaleType.DIVERGENT}</label>
            </div>
            <div className="d-flex w-100 px-2 pt-1">
