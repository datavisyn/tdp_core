...
export class FormSelect3 extends AFormElement<IFormSelect3> {
   ...
   */
  constructor(form: IForm, parentElement: HTMLElement, elementDesc: IFormSelect3, readonly pluginDesc: IPluginDesc) {
  ...
  protected build() {
    ...
    this.setAttributes(this.node.querySelector('.select3'), this.elementDesc.attributes);
  }
