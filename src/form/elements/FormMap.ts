...
export class FormMap extends AFormElement<IFormMapDesc> {
  ...
  build($formNode: d3.Selection<any>) {
    ...
    if (this.inline) {
      ...
      this.$node.html(`
          <button class="btn btn-white border border-gray-400 border-1 dropdown-toggle" type="button" id="${this.elementDesc.attributes.id}l" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
