    ...
    <>
      <div key="numericalColorChooserRadio" className="btn-group w-100 px-2 pt-2" role="group" aria-label="Basic outlined example">
        <input
          ...
          type="checkbox"
          className="btn-check"
          id={`formButton${ENumericalColorScaleType.SEQUENTIAL}`}
          autoComplete="off"
        />
        <label
          style={{ zIndex: 0 }}
          className="btn btn-outline-primary w-100"
          htmlFor={`formButton${ENumericalColorScaleType.SEQUENTIAL}`}
        ...
        <input
          ...
          type="checkbox"
          className="btn-check"
          id={`formButton${ENumericalColorScaleType.DIVERGENT}`}
          autoComplete="off"
        />
        <label
          style={{ zIndex: 0 }}
          className="btn btn-outline-primary w-100"
          htmlFor={`formButton${ENumericalColorScaleType.DIVERGENT}`}
          title="Divergent Color Scale"
        >
          {ENumericalColorScaleType.DIVERGENT}
        </label>
      </div>
