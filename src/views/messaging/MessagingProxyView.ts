...
export default class MessagingProxyView extends AView {
  ...
  private showNoHttpsMessage(url: string) {
    ...
    ${i18next.t('tdp:core.views.messaging.noHttpsMessagePart1')} <a href="" target="_blank" rel="noopener" class="alert-link">${i18next.t('tdp:core.views.messaging.noHttpsMessagePart2')}
