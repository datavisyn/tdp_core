 ...
 */
export interface IBaseVisynViewPluginDesc<Props extends IVisynViewProps<any, any> = IVisynViewProps<any, any>>
  extends IBaseViewPluginDesc,
    Partial<Omit<IPluginDesc, 'type' | 'id' | 'load'>> {
  /**
 ...
 * TODO:
 */
export type IVisynViewPlugin<Props extends IVisynViewProps<any, any> = IVisynViewProps<any, any>> = {
  /**
   * TODO:
   */
   ...
   */
  factory: never;
} & IVisynViewPluginDefinition<Props> &
  IPlugin;
 ...
 * ```
 */
export interface VisynViewPluginType<
  Type extends string,
  Props extends IVisynViewProps<any, any> = IVisynViewProps<any, any>,
  Desc extends IVisynViewPluginDesc<Props> = IVisynViewPluginDesc<Props>,
> {
  desc: Desc & {
    visynViewType: Type;
 ...
 */
type VisynSimpleViewPluginType<
  Desc extends IVisynViewPluginDesc = IVisynViewPluginDesc,
  Param extends Record<string, any> = Record<string, any>,
> = VisynViewPluginType<'simple', IVisynViewProps<Desc, Param>>;

export type IVisynSimpleViewPluginDesc = VisynSimpleViewPluginType['desc'];
export type IVisynSimpleViewPlugin = VisynSimpleViewPluginType['plugin'];
export type IVisynSimpleViewPluginDefinition = VisynSimpleViewPluginType['definition'];

export function isVisynSimpleView(desc: IVisynViewPluginDesc<any>): desc is IVisynSimpleViewPluginDesc {
  return desc?.visynViewType === 'simple';
}

/**
 * Props type for all data backed visyn view. Extends the visyn view props with data and their description.
 */
type VisynDataViewPropsType<
  Desc extends IVisynViewPluginDesc = IVisynViewPluginDesc,
  Param extends Record<string, any> = Record<string, any>,
> = IVisynViewProps<Desc, Param> & {
  /**
 ...
 * Helper type to get properly typed plugin desc, plugin and factory from just the props.
 */
type VisynDataViewPluginType<
  Desc extends IVisynViewPluginDesc = IVisynViewPluginDesc,
  Param extends Record<string, any> = Record<string, any>,
> = VisynViewPluginType<'data', VisynDataViewPropsType<Desc, Param>>;

export type IVisynDataViewPluginDesc = VisynDataViewPluginType['desc'];
export type IVisynDataViewPlugin = VisynDataViewPluginType['plugin'];
export type IVisynDataViewPluginDefinition = VisynDataViewPluginType['definition'];

export type IVisynDataViewProps<Param extends Record<string, any> = Record<string, any>> = VisynDataViewPropsType<IVisynDataViewPluginDesc, Param>;

export function isVisynDataView(desc: IVisynViewPluginDesc<any>): desc is IVisynDataViewPluginDesc {
  return desc?.visynViewType === 'data';
}
