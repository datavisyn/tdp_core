import { Selection, event as d3event, select } from 'd3v3';
...
import { ENamedSetType, INamedSet, IStoredNamedSet } from './interfaces';
...
export class NamedSetList {
  ...
  constructor(
    ...
    private readonly sessionCreator: (namedSet: INamedSet) => void,
    doc = document,
  ) {
