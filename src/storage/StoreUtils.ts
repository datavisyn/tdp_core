  ...
  static editDialog(namedSet: IStoredNamedSet, entitiesTitle: string, result: (name: string, description: string, sec: Partial<ISecureItem>) => void) {
    ...
    dialog.form.innerHTML = `
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="name" id="namedset_name" placeholder="${I18nextManager.getInstance().i18n.t(
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" name="description" id="namedset_description" rows="5" placeholder="${I18nextManager.getInstance().i18n.t(
