import {BaseUtils, I18nextManager, Permission, UserSession, EPermission, ISecureItem, UserUtils} from 'phovea_core';
...
const getAreas: () => [number, string | ((d: number) => string)][] = () => {
  return [
    ...
    [44 * MIN, (d) => I18nextManager.getInstance().i18n.t('tdp:core.utilsInternal.minute', {count: Math.ceil(d / MIN)})],
    [89 * MIN, I18nextManager.getInstance().i18n.t('tdp:core.utilsInternal.hour')],
    [21 * HOUR, (d) => I18nextManager.getInstance().i18n.t('tdp:core.utilsInternal.hour', {count: Math.ceil(d / HOUR)})],
    [35 * HOUR, I18nextManager.getInstance().i18n.t('tdp:core.utilsInternal.day')],
    [25 * DAY, (d) => I18nextManager.getInstance().i18n.t('tdp:core.utilsInternal.day', {count: Math.ceil(d / DAY)})],
    [45 * DAY, I18nextManager.getInstance().i18n.t('tdp:core.utilsInternal.month')],
    [319 * DAY, (d) => I18nextManager.getInstance().i18n.t('tdp:core.utilsInternal.month', {count: Math.ceil(d / DAY / 30)})],
    [547 * DAY, (d) => I18nextManager.getInstance().i18n.t('tdp:core.utilsInternal.hour')]
  ];
};
