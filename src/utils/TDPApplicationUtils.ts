...
import { EPermission, ISecureItem, Permission, UserUtils, UserSession } from 'visyn_core';
...
export class TDPApplicationUtils {
  ...
  static permissionForm(item?: ISecureItem, options: Partial<IPermissionFormOptions> = {}) {
    ...
    div.innerHTML = `          
      <input class="form-check-input" type="radio" data-testid="permission-private-input" name="permission_public" id="global_permission_private_${id}" value="private" ${
      ...
      <div class="form-check form-check-inline">
          <input class="form-check-input" data-testid="permission-public-input" type="radio" name="permission_public" id="global_permission_public_${id}" value="public" ${
      permission.others.has(EPermission.READ) ? 'checked' : ''
    }>
      ...
      <button type="button" name="permission_advanced"  data-testid="advanced-button" class="btn btn-outline-secondary btn-sm float-end">${I18nextManager.getInstance().i18n.t(
      ...
      <div class="tdp-permissions">
        <div class="tdp-permissions-entry row d-flex align-items-center" data-testid="public">
          ...
          <div class="btn-group col-sm-auto" role="group">
            <input type="radio" data-testid="no-permission-input" class="btn-check" name="permission_others" id="btnradio_permissions_public_${id}_none" value="none" autocomplete="off" ${
      !permission.others.has(EPermission.READ) ? 'checked' : ''
    }>
            ...
            <input type="radio" data-testid="read-input" class="btn-check" name="permission_others" id="btnradio_permissions_public_${id}_read" value="read" autocomplete="off" ${
      permission.others.has(EPermission.READ) && !permission.others.has(EPermission.WRITE) ? 'checked' : ''
            ...
            <input type="radio" data-testid="write-input" class="btn-check" name="permission_others" id="btnradio_permissions_public_${id}_write" value="write" autocomplete="off" ${
      ...
      'tdp:core.utilsInternal.group',
          ...
          <div class="btn-group col-sm-auto" role="group">
          <input type="radio" data-testid="no-permission-input" class="btn-check" name="permission_group" id="btnradio_permissions_group_${id}_none" value="none" autocomplete="off" ${
      !permission.group.has(EPermission.READ) ? 'checked' : ''
            ...
            <input type="radio" data-testid="read-input" class="btn-check" name="permission_group" id="btnradio_permissions_group_${id}_read" value="read" autocomplete="off" ${
      permission.group.has(EPermission.READ) && !permission.group.has(EPermission.WRITE) ? 'checked' : ''
            ...
            <input type="radio" data-testid="write-input" class="btn-check" name="permission_group" id="btnradio_permissions_group_${id}_write" value="write" autocomplete="off" ${
      ...
      'tdp:core.utilsInternal.buddies',
          ...
          <input id="permission_buddies_name_${id}" data-testid="permission-name-input" name="permission_buddies_name" class="form-control form-control-sm" placeholder="${I18nextManager.getInstance().i18n.t(
      'tdp:core.utilsInternal.buddiesPlaceholder',
    )}" value="${item && item.buddies ? item.buddies.join(';') : ''}">
          <div class="btn-group col-sm-auto" role="group">
            <input type="radio" data-testid="no-permission-input" class="btn-check" name="permission_buddies" id="btnradio_permissions_buddies_${id}_none" value="none" autocomplete="off" ${
      !permission.buddies.has(EPermission.READ) ? 'checked' : ''
            ...
            <input type="radio" data-testid="read-input" class="btn-check" name="permission_buddies" id="btnradio_permissions_buddies_${id}_read" value="read" autocomplete="off" ${
      permission.buddies.has(EPermission.READ) && !permission.buddies.has(EPermission.WRITE) ? 'checked' : ''
            ...
            <input type="radio" data-testid="write-input" class="btn-check" name="permission_buddies" id="btnradio_permissions_buddies_${id}_write" value="write" autocomplete="off" ${
