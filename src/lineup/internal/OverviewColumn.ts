...
export default class OverviewColumn extends BooleanColumn {
  static readonly GROUP_TRUE = {name: i18next.t('tdp:core.lineup.OverviewColumn.selectedInOverview'), color: 'white'};
  static readonly GROUP_FALSE = {name: i18next.t('tdp:core.lineup.OverviewColumn.rest'), color: '#AAAAAA'};
  ...
  constructor(id: string, desc: IBooleanColumnDesc) {
    super(id, Object.assign(desc, {
      label: i18next.t('tdp:core.lineup.OverviewColumn.overviewSelection')
    }));
  ...
  setOverview(rows?: any[], name = i18next.t('tdp:core.lineup.OverviewColumn.focus')) {
  ...
  get categoryLabels() {
    return [i18next.t('tdp:core.lineup.OverviewColumn.selectedInOverview'), i18next.t('tdp:core.lineup.OverviewColumn.rest')];
  }
