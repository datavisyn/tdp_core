 ...
 * @param {string} selector - the selector of the element as returned by cypress studio
 */
Cypress.Commands.add('clearInputForm', (selector: string) => {
 ...
 */
Cypress.Commands.add('fillInForm', (selector: string, text: string) => {
 ...
 * @param {string} selector - the selector of the element as returned by cypress studio
 */
Cypress.Commands.add('checkIfInputCompleted', (input: string, selector: string) => {
  cy.get(selector)
    .invoke('val')
    .then((text) => {
      return text === input;
