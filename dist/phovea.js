import { EP_PHOVEA_CORE_LOCALE, PluginRegistry, EP_PHOVEA_CORE_LOGIN, EP_PHOVEA_CORE_LOGOUT } from 'visyn_core/plugin';
...
export default function (registry) {
    ...
    actionCompressor('tdpCompressSetParameter', 'compressSetParameter', '(tdpSetParameter)', () => import('./utils/TDPApplicationUtils.js').then((t) => t.TDPApplicationUtils));
    // compatibility
    ...
    actionCompressor('targidCompressSetParameter', 'compressSetParameterOld', '(targidSetParameter)', () => import('./utils/TDPApplicationUtils.js').then((t) => t.TDPApplicationUtils));
    ...
    actionCompressor('ordinoScoreCompressor', 'compressComp', '(ordinoAddScore|ordinoRemoveScore)', () => import('./lineup/internal/ScoreUtils.js').then((s) => s.ScoreUtils));
