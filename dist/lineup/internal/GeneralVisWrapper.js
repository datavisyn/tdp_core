...
export class GeneralVisWrapper extends EventHandler {
    ...
    getAllData() {
        ...
        console.log(newData);
        let scoreColumns = this.provider.getColumns().filter(d => typeof d._score === 'function');
    ...
    updateCustomVis() {
        ...
        ReactDOM.render(React.createElement(CustomVis, { columns: cols,
            type: "Multiples", selectionCallback: filterCallback }), this.node);
