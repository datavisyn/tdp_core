...
import { EColumnTypes, ESupportedPlotlyVis, isScatter } from '../types/generalTypes';
import { ScatterVis } from './plotComponents/ScatterVis';
import { getCol } from '../utils/sidebarUtils';
import { ViolinVis } from './plotComponents/ViolinVis';
export function GeneralHome(props) {
    ...
    const shapeScale = useMemo(() => {
        ...
        if (isScatter(visConfig) && visConfig.) {
    ...
    return (React.createElement(React.Fragment, null,
        visConfig.type === ESupportedPlotlyVis.SCATTER ?
            React.createElement(ScatterVis, { config: visConfig, 
                // optionsConfig={{
                //     color: {
                //         enable: true,
                //     }
        ...
        visConfig.type === ESupportedPlotlyVis.VIOLIN ?
