...
export class ATableView extends AView {
    ...
    enableExport() {
        ...
        rightTableHeader.insertAdjacentHTML('beforeend', `<a class="link-secondary" href="#" title="${I18nextManager.getInstance().i18n.t('tdp:core.views.tableDownloadButton')}"><i class="fas fa-download"></i></a>`);
