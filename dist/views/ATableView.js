...
export class ATableView extends AView {
    ...
    enableExport() {
        ...
        rightTableHeader.insertAdjacentHTML('beforeend', `<a href="#" title="${I18nextManager.getInstance().i18n.t('tdp:core.views.tableDownloadButton')}"><i class="fa fa-download"></i></a>`);
