...
export function MainApp() {
    ...
    return (React.createElement(VisynApp, { header: React.createElement(VisynHeader, { userMenu: user ? (React.createElement(React.Fragment, null,
                ...
                React.createElement(Menu.Item, { onClick: () => {
                        LoginUtils.logout();
                    } }, "Logout"))) : null, userName: user ? user.name : null, backgroundColor: "dark" }), appShellProps: {} }, user ? React.createElement(Vis, { columns: irisData, externalConfig: visConfig, setExternalConfig: setVisConfig }) : null));
}
