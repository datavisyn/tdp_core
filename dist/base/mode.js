...
export class ButtonModeSelector {
    ...
    build(parent) {
        const testId = 'clue-mode-buttonmodeselector';
        ...
        <label for="mode_radio_btngroup_1" class="form-label btn btn-${this.options.size} clue-${CLUEMode.modes.Exploration.toString()}${CLUEMode.modes.Exploration === ModeWrapper.getInstance().getMode() ? ' active' : ''}" data-testid="${testId}-exploration">
        ...
        <label for="mode_radio_btngroup_2" class="form-label btn btn-${this.options.size} clue-${CLUEMode.modes.Authoring.toString()}${CLUEMode.modes.Authoring === ModeWrapper.getInstance().getMode() ? ' active' : ''}" data-testid="${testId}-authoring">
        ...
        <label for="mode_radio_btngroup_3" class="form-label btn btn-${this.options.size} clue-${CLUEMode.modes.Presentation.toString()}${CLUEMode.modes.Presentation === ModeWrapper.getInstance().getMode() ? ' active' : ''}"  data-testid="${testId}-presentation">
