...
export function FilterCard({ filter, onDrop, onDelete, onChange, onValueChanged, filterComponents }) {
    var _a, _b, _c;
    ...
    return (React.createElement("div", { className: `card mb-2 ${isDragging ? 'bg-light' : ''}`, ref: preview, style: filter.disableRemoving && filter.disableDragging ? { height: '93%' } : {} },
        React.createElement("div", { className: "card-body" },
            React.createElement("h6", { ref: filter.disableDragging ? undefined : drag, className: "card-title d-flex", style: filter.disableDragging ? {} : { cursor: 'move' } },
                ...
                React.createElement("div", null,
                    React.createElement("div", { className: "input-group" },
                        ...
                        !filter.disableRemoving && onDelete ? (React.createElement("button", { className: "btn btn-secondary btn-sm", onClick: () => onDelete(filter) },
                            React.createElement("i", { className: "fas fa-times" }))) : null))),
            filterComponent ? (React.createElement("div", null,
                React.createElement(filterComponent.clazz, { value: filter.componentId, onValueChanged: onValueChanged
            ...
            _c.map((child, i, allChildren) => (React.createElement(React.Fragment, { key: child.id },
                React.createElement(FilterCard, { key: child.id, filter: child, onDrop: onDrop, onDelete: onDelete, onValueChanged: onValueChanged, onChange: onChange, filterComponents: filterComponents }),
