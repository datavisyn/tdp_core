    ...
    return (React.createElement(React.Fragment, null, confirmStatus === 'pending' ?
        ...
        : React.createElement(React.Fragment, null, selectedAlert.latest_diff || selectedAlert.confirmed_data ? (React.createElement(React.Fragment, null,
            ...
            selectedAlert.latest_diff ? React.createElement("div", { className: "p-1" },
                confirmError ? React.createElement(ErrorMessage, { error: new Error(`While confirming an error occured: ${confirmError}`) }) : null,
                React.createElement("div", { className: "d-md-flex justify-content-md-end" },
                    React.createElement("button", { title: "Confirm changes", className: "btn btn-primary", onClick: () => doConfirm() }, "Confirm"))) : null)) : React.createElement("p", { className: "m-3" }, "No new data available"))));
}
