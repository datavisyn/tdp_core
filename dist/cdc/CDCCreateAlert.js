...
export function CDCCreateAlert({ alertData, setAlertData, filterSelection, filter, setFilter, filterComponents, alertList, setAlertList, setCreationMode, setSelectedAlert }) {
    const generalInformation = (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: "mb-3" },
            ...
            React.createElement("input", { type: "text", className: "form-control", disabled: true, value: alertData.cdc_id, onChange: (e) => setAlertData({ ...alertData, cdc_id: e.target.value }) })),
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "d-flex w-100 justify-content-between mb-1" },
            ...
            React.createElement("small", null,
                ...
                React.createElement("button", { title: "Discard changes", className: "btn btn-secondary ms-1", onClick: () => setCreationMode(false) },
