    ...
    return React.createElement(React.Fragment, null,
        React.createElement("div", { className: "input-group m-1 row" },
            React.createElement("div", { className: "col-4 p-0" },
                React.createElement(Select, { isDisabled: !onValueChanged || disabled, value: { label: field, value: field }, options: [...config === null || config === void 0 ? void 0 : config.map((conf) => { return { label: conf.field, value: conf.field }; })], onChange: (e) => {
                        onFieldChanged === null || onFieldChanged === void 0 ? void 0 : onFieldChanged(e.value);
