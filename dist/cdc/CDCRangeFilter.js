...
function CDCRangeFilterComponent({ value, onValueChanged, disabled }) {
    return React.createElement("div", { className: "t360-input-range-wrapper", style: { margin: '10px', paddingTop: '10px', minHeight: '50px' } },
        React.createElement(InputRange, { disabled: !onValueChanged || disabled, maxValue: 2021, minValue: 1950, value: { min: value.min, max: value.max }, onChange: (v) => onValueChanged === null || onValueChanged === void 0 ? void 0 : onValueChanged(v) }));
}
