        ...
        def refresh_expiring_jwts(response):
            try:
                ...
                if target_timestamp > exp_timestamp:
                    access_token = create_access_token(self.current_user.name)  # create_access_token_from_user(user)
...
def login():
    ...
    access_token = create_access_token(user.name)  # create_access_token_from_user(user)
